...
class Passaro:
    ...
    def desenhar(self, tela):
        ...
        # se o passo tiver caindo eu não vou bater asa
        if self.angulo <= -80:
            self.imagem = self.IMGS[1]
...
class Cano:
    ...
    def colidir(self, passaro):
        ...
        topo_ponto = passaro.get_mask().overlap(base_mask, distancia_topo)
        base_ponto = passaro.get_mask().overlap(base_mask, distancia_base)
